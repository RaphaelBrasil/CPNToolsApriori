...
public class Apriori {
	...
	public ArrayList<String> apriori (ArrayList<ArrayList<String>> pTransaction, int minSup) {

		// Get input
		
		//int numberOfTransactions = nTrans;
...
/*
		...
		//"Minumum support count
		int minSupportCount = minSup;
		...
		while (true) {
			...
			if (itemSetsWithMinSupportCount.size() == 0) {
				return items;//prevItemSetsWithMinSupportCount;
